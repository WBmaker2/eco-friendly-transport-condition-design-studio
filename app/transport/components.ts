...
export const components: ComponentOption[] = [
  ...
  c("reinforced-bed", "structure", "튼튼한 큰 짐받이", "무거운 책 상자", "무거운 짐을 받치기 쉬워요.", "수레가 무거워지고 재료가 더 필요해요.", { load: 3, distance: 1, rough: 2, uphill: 2, stability: 2, control: 1 }, "weight"),
  ...
  c("basic-control", "control", "기본 방향·멈춤 장치", "평평하고 넓은 길", "단순하고 가벼워요.", "좁은 길과 경사길에서는 방향을 바꾸거나 멈추기 어려워요.", { load: 1, distance: 1, rough: 1, uphill: 1, stability: 1, control: 1 }, "complexity"),
