...
export function HelpDialog({ open, onClose, type }: { open: boolean; onClose: () => void; type: "updates" | "teacher" | "principles" }) {
  ...
  return <div className="dialog-backdrop" role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) onClose(); }}>
    <section className="dialog" role="dialog" aria-modal="true" aria-labelledby="dialog-title">
      ...
      {type === "updates" ? <div className="update-list"><article><b>2026-08-31 · v0.4.3</b><p>단계를 바꿀 때 화면을 맨 위로 돌리고, 할 일 그림을 더 크게 보이도록 다듬었습니다.</p></article><article><b>2026-08-17 · v0.4.2</b><p>학습 그림이 잘리지 않도록 그림 전체가 보이는 반응형 상자로 바꿨습니다.</p></article><article><b>2026-08-17 · v0.4.1</b><p>사이트 설명도 초등 3~4학년용으로 맞췄습니다.</p></article><article><b>2026-08-16 · v0.4.0</b><p>미션마다 생성형 학습 그림을 넣고, 초록 수레 미리보기 그림도 새로 만들었습니다. 그림 속 글자 없이 쉬운 설명과 대체 문구로 내용을 안내합니다.</p></article><article><b>2026-07-18 · v0.3.0</b><p>초등 3~4학년이 쉽게 읽도록 말을 고치고, 부품을 네 단계로 하나씩 고르게 바꿨습니다. 결과의 까닭과 생각할 점도 더 또렷하게 보여 줍니다.</p></article><article><b>2026-07-17 · v0.2.0</b><p>모바일 화면과 글자 크기, 할 일 선택 화면을 다듬고 이전 단계 버튼을 추가했습니다.</p></article><article><b>2026-07-17 · v0.1.0</b><p>친환경 수송 조건 설계소의 첫 버전을 만들었습니다.</p></article></div> : null}
